...
.nav-toggle:hover span { background: var(--teal-700); }

/* Hide mobile-only nav items on desktop */
.site-nav .nav-cta-mobile,
.site-nav .nav-contact-mobile { display: none; }

/* CTA short/long swap */
.btn-cta .cta-short { display: none; }
.btn-cta .cta-long { display: inline; }
...
@media (max-width: 920px) {
  ...
  .brand-text .loc { font-size: 9px; letter-spacing: 0.14em; }
  ...
  .btn-cta .cta-short { display: inline; }
  ...
  .site-nav .nav-contact-mobile:first-of-type {
    border-top: 1px solid var(--line);
    margin-top: 8px;
  }
...
@media (max-width: 480px) {
  .brand-text .loc { display: none; }
  .utility-bar .langs { display: none; }
  .container { padding: 0 16px; }
  .hero { padding: 56px 0 64px; }
  .site-nav { max-height: calc(100dvh - 88px); }
}
...
<header class="site-header">
  <div class="container">
    ...
    <nav class="site-nav" id="site-nav" aria-label="Main navigation">
      ...
      <a class="nav-cta-mobile" href="{url('/consultation/')}">Book a Consultation</a>
      <a class="nav-contact-mobile" href="tel:{PHONE_DIGITS}">{PHONE}</a>
      <a class="nav-contact-mobile" href="mailto:{EMAIL}">{EMAIL}</a>
    </nav>
    <a class="btn btn-gold btn-cta" href="{url('/consultation/')}">
      <span class="cta-long">Book Consultation</span>
      <span class="cta-short">Book</span>
    </a>
    <button class="nav-toggle" aria-label="Toggle menu" aria-controls="site-nav" aria-expanded="false"
            onclick="var b=document.body,o=b.classList.toggle('nav-open');this.setAttribute('aria-expanded',o)">
